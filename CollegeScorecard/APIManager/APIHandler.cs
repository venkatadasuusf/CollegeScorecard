...
//This class is used for API connectivity and retrieving the data from API
...
namespace CollegeScorecard.APIManager
{
    public class APIHandler
    {
        ...
        static string API_KEY = "DdRtYjTmssGhBJUm2xAoIjGpgxumbWuQXKEe2498"; //API key
        ...
        // The below methods retrieves StudentBody, Cost details for the selected college. School ID is passed as a parameter to the API
